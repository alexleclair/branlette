...
App = 
		...
		config:
			...
			labels: {}
				...
				# ludismedia:	'Ludis Média'
				# aldo:		'Aldo'
				# hypractif:	'Hypractif'
				# exacto:		'Exacto'

				# inbox:		'Inbox Internationnal'
				...
				# sidlee:		'Sid Lee'
				# sidleetechnologies:		'Sid Lee Technologies'
				# lagrange:	'La Grange'
				# passwordbox:'Passwordbox'
				# tamtam:		'TAM-TAM\\TBWA'
				# twistimage:	'Twist Image'
				# uranium:	'Uranium'
				# thoseyellowkids:'Those Yellow Kids'
				# vortex:		'Vortex'
				# lesite:		'Le Site'
				# tink:		'Tink'
				# tank:		'TANK'
		...
		init: (config)->
				...
				# 	console.log App.config.labels[key];
